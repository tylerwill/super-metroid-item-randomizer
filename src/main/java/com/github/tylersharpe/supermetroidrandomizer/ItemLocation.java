...
import static com.github.tylersharpe.supermetroidrandomizer.CommonProgressionRules.*;
...
public enum ItemLocation {
  ...
  OLD_MOTHER_BRAIN(
      ...
      NORMAL,
      0x783ee,
      ZEBES_AWAKE.and((a, s) -> a.contains(CLEAR_BOMB_PASSAGES))
  ),
  ...
  TOOTH_HURTY_MISSILES(
      "Missiles (tooth hurty)",
      MINOR,
      NORMAL,
      0x78486,
      ZEBES_AWAKE.and((a, s) -> a.contains(CLEAR_BOMB_PASSAGES))
  ...
  LANDING_SITE_POWER_BOMBS(
      ...
      ZEBES_AWAKE.and((a, s) ->
          a.contains(CLEAR_POWER_BOMB_OBSTRUCTIONS) &&
          (a.contains(ProgressionAbility.SPEED_BOOSTER) || a.contains(ProgressionAbility.SPACE_JUMP) || a.contains(CLEAR_BOMB_PASSAGES)
      )
  )),
  ...
  GAUNTLET(
      ...
      0x78264,
      EnumSet.of(VARIA_SUIT, Item.GRAVITY_SUIT),
      ZEBES_AWAKE.and((a, s) -> a.contains(CLEAR_BRITTLE_WALLS)),
      (a, s) -> true
  ),
  ...
  TERMINATOR(
      ...
      0x78432,
      EnumSet.of(VARIA_SUIT, Item.GRAVITY_SUIT),
      ZEBES_AWAKE.and((a, s) -> a.contains(CLEAR_BRITTLE_WALLS) || s.contains(SHORT_CHARGE)),
      (a, s) -> true
  ),
  ...
  EARLY_SUPERS_SECRET_MISSILES_2(
      ...
      HIDDEN,
      0x78532,
      EARLY_SUPERS_SUPER_MISSILES.canAccess.and((a, s) -> a.contains(CLEAR_BOMB_PASSAGES))
  ),
  ...
  CHARGE_BEAM(
      ...
      CHOZO,
      0x78614,
      BIG_PINK.and((a, s) -> a.contains(CLEAR_BOMB_PASSAGES))
  ),
  ...
  BUBBLE_MOUNTAIN_MISSILES(
      ...
      NORMAL,
      0x78c66,
      HEATED_UPPER_NORFAIR.and((a, s) -> a.contains(CLEAR_BOMB_PASSAGES))
  ),
