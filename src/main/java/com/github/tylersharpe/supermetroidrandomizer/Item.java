...
public enum Item {
    ...
    MISSILES(MINOR, 46, 0xdbee, 0x2fef, 0x83ef,
            ProgressionAbility.MISSILES),
    SUPER_MISSILES(MINOR, 10, 0xdfee, 0x33ef, 0x87ef,
            ProgressionAbility.MISSILES, ProgressionAbility.SUPER_MISSILES),
